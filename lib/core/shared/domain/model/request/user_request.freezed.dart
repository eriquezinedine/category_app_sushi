...
class _$UserRequestImpl implements _UserRequest {
  _$UserRequestImpl(
      {required this.email, required this.displayName, this.photoURL});
  ...
  @override
  String toString() {
    return 'UserRequest(email: $email, displayName: $displayName, photoURL: $photoURL)';
  }
...
abstract class _UserRequest implements UserRequest {
  factory _UserRequest(
      ...
      final String? photoURL}) = _$UserRequestImpl;
