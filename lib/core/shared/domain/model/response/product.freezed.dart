...
class _$ProductImpl implements _Product {
  _$ProductImpl(
      ...
      final List<Additional> additionals = const []})
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, price: $price, image: $image, status: $status, description: $description, category: $category, ingredients: $ingredients, prices: $prices, additionals: $additionals)';
  }
...
abstract class _Product implements Product {
  factory _Product(
      ...
      final List<Additional> additionals}) = _$ProductImpl;
