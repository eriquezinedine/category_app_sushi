...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Duration? timeRemaining, int? value, int? countdown});
}
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({this.timeRemaining, this.value, this.countdown});
  ...
  @override
  String toString() {
    return 'HomeState(timeRemaining: $timeRemaining, value: $value, countdown: $countdown)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, timeRemaining, value, countdown);
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      {final Duration? timeRemaining,
      final int? value,
      final int? countdown}) = _$HomeStateImpl;
